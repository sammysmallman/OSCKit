...
@objc(OSCTcpServerConfiguration) public class OSCTcpServerConfiguration: NSObject, NSSecureCoding, Codable, Identifiable {
    ...
    /// A key that defines the `id` of an `OSCTcpServerConfiguration`.
